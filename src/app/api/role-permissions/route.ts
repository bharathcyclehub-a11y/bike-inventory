...
export const APP_FEATURES = [
  { key: "dashboard", label: "Dashboard (Home)", hasApprove: false, hasCreate: false },
  { key: "inbound", label: "Inbound Tracking", hasApprove: true, hasCreate: true },
  { key: "deliveries", label: "Deliveries & Dispatch", hasApprove: true, hasCreate: true },
  { key: "stock", label: "Stock & Inventory", hasApprove: false, hasCreate: false },
  { key: "stock_audit", label: "Stock Audit / Count", hasApprove: true, hasCreate: true },
  { key: "transfers", label: "Stock Transfers", hasApprove: true, hasCreate: true },
  { key: "vendors", label: "Vendors", hasApprove: false, hasCreate: true },
  { key: "bills", label: "Bills & Payments", hasApprove: true, hasCreate: true },
  { key: "purchase_orders", label: "Purchase Orders", hasApprove: true, hasCreate: true },
  { key: "expenses", label: "Expenses", hasApprove: true, hasCreate: true },
  { key: "reports", label: "Reports", hasApprove: false, hasCreate: false },
  { key: "team", label: "Team Management", hasApprove: false, hasCreate: false },
  { key: "barcode", label: "Barcode Scanner", hasApprove: false, hasCreate: false },
  { key: "reorder", label: "Reorder & AI Insights", hasApprove: false, hasCreate: false },
  { key: "second_hand", label: "Second Hand / Refurbished", hasApprove: false, hasCreate: true },
  { key: "zoho", label: "Zoho Settings & Sync", hasApprove: false, hasCreate: false },
  { key: "whatsapp_templates", label: "WhatsApp Templates", hasApprove: false, hasCreate: false },
  { key: "customers", label: "Customers & Receivables", hasApprove: false, hasCreate: true },
  { key: "vendor_issues", label: "Vendor Issues", hasApprove: false, hasCreate: true },
];
...
const DEFAULT_PERMISSIONS: RolePermissions = {
  ADMIN: Object.fromEntries(APP_FEATURES.map(f => [f.key, { view: true, create: true, edit: true, delete: true, approve: true }])),
    ...
    for (const role of Object.keys(DEFAULT_PERMISSIONS)) {
      ...
      for (const feature of APP_FEATURES) {
        merged[role][feature.key] = {
          ...DEFAULT_PERMISSIONS[role]?.[feature.key] || { view: false, create: false, edit: false, delete: false, approve: false },
...
export async function PUT(req: NextRequest) {
  try {
    ...
    if (permissions.ADMIN) {
      for (const feature of APP_FEATURES) {
        permissions.ADMIN[feature.key] = { view: true, create: true, edit: true, delete: true, approve: true };
      }
    }
