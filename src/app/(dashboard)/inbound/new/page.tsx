...
export default function NewInboundPage() {
  ...
  const handleSubmit = async () => {
    if (!selectedBrand || !billNo || !billDate || lineItems.length === 0) {
      setError("Brand, bill number, bill date, and at least one item required");
      return;
    }
    setStep("submitting");
    setError("");
        ...
        {(step === "verify" || step === "submitting") && (
          <>
            ...
            <Button type="button" size="lg" onClick={handleSubmit}
              disabled={step === "submitting" || !selectedBrand || !billNo || !billDate || lineItems.length === 0}
